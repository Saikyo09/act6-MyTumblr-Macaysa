        ...
        <div class="bg-white shadow rounded overflow-hidden">
            ...
            <div class="px-4 py-3">
                ...
                <div class="p-4 rounded shadow-sm bg-light">
                    <p class="font-italic mb-0">Future Full-stack Web Developer</p>
                    <p class="font-italic mb-0">Future Mobile App Developer</p>
                    <p class="font-italic mb-0">Future Photographer/Videographer</p>
                </div>
            </div>
